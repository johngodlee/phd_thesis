...
\lstinputlisting[float, floatplacement=h, label=bicuar:diam_est,language=R,caption={[Stem taper diameter estimation]R function to estimate stem diameter at 1.3 m from a model of tree taper}]{inc/diam_est.R}
