...
\begin{figure}[p]
	\centering
	\subfloat[]{{\includegraphics[width=0.6\textwidth]{img/all_nmds_envfit}}\label{bicuar:all_nmds_envfit}}%
    \qquad
\subfloat[]{{\includegraphics[width=0.6\textwidth]{img/all_nmds_envfit_low}}\label{bicuar:all_nmds_envfit_low}}%
