...
\input{inc/data_descrip_figures.tex}
\input{inc/dbh_bin_figures.tex}
\input{inc/beta_div_figures.tex}
\input{inc/plot_div_figures.tex}
\input{inc/degrad_figures.tex}

\input{bicuar_defin.tex}
...
\begin{landscape}
\input{inc/degrad_anova_table.tex}
\end{landscape}
...
\lstinputlisting[float, floatplacement=p, label=bicuar:diam_est,language=R,caption={[Stem taper diameter estimation]R function to estimate stem diameter at 1.3 m from a model of tree taper}]{inc/diam_est.R}
