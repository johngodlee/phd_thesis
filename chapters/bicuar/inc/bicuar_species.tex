...
\toprule
{Family} & {Species} & \multicolumn{1}{p{2.5cm}}{\centering Stem diam.\\(cm)} & \multicolumn{1}{p{2cm}}{\centering Basal area\\(m\textsuperscript{2} ha\textsuperscript{-1})} & {N stems} & {N stems ha\textsuperscript{-1}} \\
\midrule
