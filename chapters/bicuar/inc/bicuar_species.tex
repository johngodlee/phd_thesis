\begin{longtable}{rrccS[table-format=3.0]c} 
...
\toprule
{Family} & {Species} & {\thead{Stem diam.\\(cm)}} & {\thead{Basal area\\(m\textsuperscript{2} ha\textsuperscript{-1})}} & {N stems} & {N stems ha\textsuperscript{-1}} \\
\midrule
\endfirsthead
\toprule
{Family} & {Species} & {\thead{Stem diam.\\(cm)}} & {\thead{Basal area\\(m\textsuperscript{2} ha\textsuperscript{-1})}} & {N stems} & {N stems ha\textsuperscript{-1}} \\
