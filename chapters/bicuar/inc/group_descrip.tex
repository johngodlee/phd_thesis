\begin{table}
	...
	\begin{tabular}{lS[table-format=2.1]S[table-format=4.0]S[table-format=-3.0]S[table-format=-2.2]S[table-format=2.2]S[table-format=2.0]S[table-format=3.0]} 
\toprule
{Plot group} & {\thead{MAT\\(\textdegree{}C)}} & {\thead{MAP\\(mm y\textsuperscript{-1})}} & {\thead{CWD\\(mm y\textsuperscript{-1})}} & {\thead{Latitude\\(DD)}} & {\thead{Longitude\\(DD)}} & {\thead{N\\plots}} & {\thead{N\\species}} \\
\midrule
