...
\input{data_legacy_defin.tex}
\chapter{\chaptertitle}
\label{ch:data_legacy}
...
\centering
	...
	\caption{Two large old trees in Kilwa District, southeast Tanzania, with particularly idiosyncratic trunks. Using conventional stem diameter allometries will likely produce an inaccurate estimate of above-ground biomass. Photos by Ellie Wood.}
	\label{big_tree}
\end{figure}
...
\centering
	...
	\caption{A severely fluted \textit{Brachystegia tamarindoides} stem found in Bicuar National Park, Angola. Due to the decomposition of wood in the stem interior, simple stem diameter based biomass allometries will over-estimate the biomass of this stem.}
	\label{flute}
\end{figure}
